...
def history_feature(data, alpha_list, length):
...
def feature_engineer(data, window_size):
    ...
    data = history_feature(data, alpha_list, length)
...
def train_model(data, day, backtrade_path):
    X_train, Y_train, X_val, Y_val, test, feature_names = train_preprocess(data)
...
def train_postprocess(X_val, test):
    # prediction and save
