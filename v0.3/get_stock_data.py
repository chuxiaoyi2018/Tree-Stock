...
#     mode = "all"
#     train_path = './stockdata/5min_train'
#     mkdir(train_path)
#     downloader = Downloader(train_path, date_start='2022-07-01', date_end='2022-07-23', mode=mode)
#     downloader.run()
#     raise ValueError

#     test_path = './stockdata/5min_test'
#     mkdir(test_path)
#     downloader = Downloader(test_path, date_start='2022-03-01', date_end='2022-03-31', mode=mode)
#     downloader.run()
